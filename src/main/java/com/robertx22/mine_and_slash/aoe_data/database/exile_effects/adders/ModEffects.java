...
public class ModEffects implements ExileRegistryInit {
        ...
        public static EffectCtx ICE_GOLEM_BUFF = new EffectCtx("ice_golem_buff", "Ice Golem Buff", Elements.Cold,
                        EffectType.beneficial);
        public static EffectCtx LIGHTNING_GOLEM_BUFF = new EffectCtx("lightning_golem_buff", "Lightning Golem Buff",
                        Elements.Nature, EffectType.beneficial);
        public static EffectCtx FIRE_GOLEM_BUFF = new EffectCtx("fire_golem_buff", "Fire Golem Buff", Elements.Fire,
                        EffectType.beneficial);

        public static EffectCtx POWER_CHARGE = new EffectCtx("power_charge", "Power Charge", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx FRENZY_CHARGE = new EffectCtx("frenzy_charge", "Frenzy Charge", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx ENDURANCE_CHARGE = new EffectCtx("endurance_charge", "Endurance Charge",
                        Elements.Physical, EffectType.beneficial);

        public static EffectCtx VAMPIRIC_BLOOD = new EffectCtx("vamp_blood", "Vamp Blood", Elements.Fire,
                        EffectType.beneficial);
        public static EffectCtx DRACONIC_BLOOD = new EffectCtx("draconic_blood", "Dragon Blood", Elements.Fire,
                        EffectType.beneficial);
        public static EffectCtx REJUVENATE = new EffectCtx("rejuvenation", "Rejuvenation", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx VALOR = new EffectCtx("valor", "Valor", Elements.Physical, EffectType.beneficial);
        public static EffectCtx PERSEVERANCE = new EffectCtx("perseverance", "Perseverance", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx VIGOR = new EffectCtx("vigor", "Vigor", Elements.Physical, EffectType.beneficial);
        public static EffectCtx TAUNT_STANCE = new EffectCtx("taunt_stance", "Taunt Stance", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx UNDYING_WILL = new EffectCtx("undying_will", "Undying Will", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx MAGE_CIRCLE = new EffectCtx("mage_circle", "Mage Circle", Elements.Elemental,
                        EffectType.beneficial);
        ...
        public static EffectCtx GALE_FORCE = new EffectCtx("gale_force", "Gale Force", Elements.Physical,
                        EffectType.beneficial);
        ...
        public static EffectCtx CURSE_AGONY = new EffectCtx("agony", "Physical Agony", Elements.Elemental,
                        EffectType.negative);
        public static EffectCtx CURSE_WEAKNESS = new EffectCtx("weak", "Elemental Weakness", Elements.Elemental,
                        EffectType.negative);
        public static EffectCtx DESPAIR = new EffectCtx("despair", "Despair of Chaos", Elements.Elemental,
                        EffectType.negative);

        public static EffectCtx CHARM = new EffectCtx("charm", "Charm", Elements.Elemental, EffectType.negative);
        public static EffectCtx GROUNDING = new EffectCtx("ground", "Grounding", Elements.Physical,
                        EffectType.negative);
        ...
        public static EffectCtx INNER_CALM = new EffectCtx("inner_calm", "Inner Calm", Elements.Physical,
                        EffectType.beneficial);
        public static EffectCtx BONE_CHILL = new EffectCtx("bone_chill", "Bone Chill", Elements.Cold,
                        EffectType.negative);
        public static EffectCtx FROST_LICH = new EffectCtx("frost_lich", "Frost Lich", Elements.Cold,
                        EffectType.beneficial);
        public static EffectCtx ESSENCE_OF_FROST = new EffectCtx("essence_of_frost", "Essence of Frost", Elements.Cold,
                        EffectType.beneficial);

        public static EffectCtx BLIZZARD_REDUCE_HEAL_STRENGTH = new EffectCtx("blizzard_reduce_heal_strength",
                        "Blizzard Debuff", Elements.Cold, EffectType.negative);
        ...
        public void registerAll() {
                ...
                ExileEffectBuilder.of(ModEffects.GALE_FORCE)
                                .vanillaStat(VanillaStatData.create(MOVEMENT_SPEED.value(), 0.01F, ModType.MORE,
                ...
                ExileEffectBuilder.of(ModEffects.THORN)
                                ...
                                .spell(SpellBuilder.forEffect()
                                                .addSpecificAction(SpellCtx.ON_ENTITY_ATTACKED,
                                                                PartBuilder.damage(SpellCalcs.THORN_CONSUME,
                                                                                Elements.Physical))
                                                .addSpecificAction(SpellCtx.ON_ENTITY_ATTACKED,
                                                                PartBuilder.removeExileEffectStacksToTarget(
                                                                                ModEffects.THORN.resourcePath))
                ...
                ExileEffectBuilder.of(ModEffects.GROUNDING)
                                .maxStacks(1)
                                .spell(SpellBuilder.forEffect()
                                                .onTick(PartBuilder.justAction(SpellAction.SET_ADD_MOTION
                                                                .create(SetAdd.ADD, 1D, ParticleMotion.Downwards))
                ...
                ExileEffectBuilder.of(ModEffects.SLOW)
                                .vanillaStat(VanillaStatData.create(MOVEMENT_SPEED.value(), -0.25F, ModType.MORE,
                                                UUID.fromString("3fb10485-f309-468f-afc6-a23b0d6cf4c1")))
                                .vanillaStat(VanillaStatData.create(ATTACK_SPEED.value(), -0.10F, ModType.MORE,
                                                UUID.fromString("00fb60a7-904b-462f-a7cb-a557f02e362e")))
                                .addTags(EffectTags.negative)
                                .build();

                ExileEffectBuilder.of(ModEffects.STUN)
                                .addTags(EffectTags.immobilizing, EffectTags.negative)
                                .vanillaStat(VanillaStatData.create(MOVEMENT_SPEED.value(), -10.0F, ModType.MORE,
                                                UUID.fromString("3fb10485-f309-468f-afc6-a23b0d6cf4c1")))
                                .vanillaStat(VanillaStatData.create(ATTACK_SPEED.value(), -10.0F, ModType.MORE,
                                                UUID.fromString("00fb60a7-904b-462f-a7cb-a557f02e362e")))
                                .vanillaStat(VanillaStatData.create(ATTACK_DAMAGE.value(), -10.0F, ModType.MORE,
                                                UUID.fromString("10fb60a7-904b-462f-a7cb-a557f02e362e")))
                                .build();

                ExileEffectBuilder.of(ModEffects.BLIND)
                                .vanillaStat(VanillaStatData.create(ATTACK_DAMAGE.value(), -10.0F, ModType.MORE,
                                                UUID.fromString("5eccf34c-29f7-4eea-bbad-82a905594064")))
                                .vanillaStat(VanillaStatData.create(ATTACK_SPEED.value(), -10.0F, ModType.MORE,
                                                UUID.fromString("57eb6210-2a42-4ad3-a604-6f679d440a9b")))
                                .spell(SpellBuilder.forEffect()
                ...
                ExileEffectBuilder.of(ModEffects.PETRIFY)
                                .addTags(EffectTags.immobilizing)
                                .vanillaStat(VanillaStatData.create(MOVEMENT_SPEED.value(), -10.0F, ModType.MORE,
                                                UUID.fromString("bd9d32fa-c8c2-455c-92aa-4a94c2a70cd5")))
                                .spell(SpellBuilder.forEffect()
                                                .onTick(PartBuilder.aoeParticles(ParticleTypes.ITEM_SLIME, 10D, 1D)
                                                                .tick(20D))
                                                .onExpire(PartBuilder
                                                                .justAction(SpellAction.DEAL_DAMAGE.create(
                                                                                SpellCalcs.PETRIFY, Elements.Shadow))
                                                                .setTarget(TargetSelector.TARGET.create()))
                                                .onExpire(PartBuilder.aoeParticles(ParticleTypes.CLOUD, 15D, 1D))
                                                .onExpire(PartBuilder.justAction(SpellAction.PLAY_SOUND
                                                                .create(SoundEvents.SHEEP_SHEAR, 1D, 1D)))
                                                .buildForEffect())
                                .build();
                ...
                ExileEffectBuilder.of(TAUNT_STANCE)
                                ...
                                .spell(SpellBuilder.forEffect()
                                                .onTick(PartBuilder
                                                                .justAction(SpellAction.AGGRO.create(SpellCalcs.TAUNT,
                                                                                AggroAction.Type.AGGRO))
                                                                .setTarget(TargetSelector.AOE.create(10D,
                ...
                ExileEffectBuilder.of(REJUVENATE)
                                ...
                                .spell(SpellBuilder.forEffect()
                                                .onTick(PartBuilder
                                                                .justAction(SpellAction.RESTORE_HEALTH
                                                                                .create(SpellCalcs.REJUVENATION))
                                                                .setTarget(TargetSelector.TARGET.create())
                                                                .tick(20D))
                ...
                ExileEffectBuilder.of(INNER_CALM)
                                ...
                                .spell(SpellBuilder.forEffect()
                                                .onTick(PartBuilder
                                                                .justAction(SpellAction.RESTORE_MANA
                                                                                .create(SpellCalcs.REJUVENATION))
                                                                .setTarget(TargetSelector.TARGET.create())
                                                                .tick(20D))
