...
public class NatureSpells implements ExileRegistryInit {
        ...
        public void registerAll() {
                ...
                SpellBuilder.of(BOSS_CC_RESISTANCE, PlayStyle.INT, SpellConfiguration.Builder.instant(0, 20 * 5),
                                ...
                                // todo rework activate in spell effects into boolean return so i can do
                                // something when say effect is removed without having to check first
                ...
                SpellBuilder.of(CHAOS_TOTEM, PlayStyle.STR, SpellConfiguration.Builder.nonInstant(40, 20 * 60, 40),
                                "Chaos Totem",
                                Arrays.asList(SpellTags.area, SpellTags.damage, SpellTags.totem, SpellTags.CHAOS))

                                .manualDesc("Summons a totem that spawns chaos meteors, dealing "
                                                + SpellCalcs.CHAOS_TOTEM.getLocDmgTooltip(Elements.Shadow)
                                                + " in an area.")
                                ...
                                .onTick("totem", PartBuilder.groundEdgeParticles(ParticleTypes.WITCH, 100D, 3D, 0.5D)
                                                .tick(2D))

                                .onTick("totem", PartBuilder.aoeSelectEnemies(10D, 50D).tick(20D)
                                                .addPerEntityHit(PartBuilder.justAction(SpellAction.SUMMON_BLOCK
                                                                .create(Blocks.PURPLE_GLAZED_TERRACOTTA, 200D)
                                ...
                                .onExpire("meteor",
                                                PartBuilder.damageInAoe(SpellCalcs.CHAOS_TOTEM, Elements.Shadow, 2D))
                ...
                SpellBuilder.of(THORN_BUSH, PlayStyle.INT, SpellConfiguration.Builder.instant(15, 20 * 6)
                                ...
                                .manualDesc("Summon a thorny bush that deals "
                                                ...
                                                + " in an area every second and applies Thorned. " +
                                ...
                                .onExpire(PartBuilder.justAction(
                                                SpellAction.SUMMON_BLOCK.create(SlashBlocks.THORN_BUSH.get(), 20D * 5)
                                ...
                                .onTick("block", PartBuilder.damageInAoe(SpellCalcs.THORN_BUSH, Elements.Physical, 3D)
                                                .tick(20D).noKnock())
                                .onTick("block", PartBuilder.addExileEffectToEnemiesInAoe(ModEffects.THORN.resourcePath,
                                                3D, 20 * 8D).tick(20D))
                                .onTick("block", PartBuilder.playSound(SoundEvents.GRASS_BREAK, 1D, 1D).tick(20D))
                                .levelReq(20)
                                .build();

                SpellBuilder.of(POISON_CLOUD, PlayStyle.INT, SpellConfiguration.Builder.instant(30, 20 * 45),
                                "Acid Cloud",
                                Arrays.asList(SpellTags.area, SpellTags.damage, SpellTags.CHAOS))
                                .manualDesc(
                                                "Erupt with poisonous gas, dealing "
                                                                + SpellCalcs.POISON_CLOUD.getLocDmgTooltip()
                ...
                SpellBuilder.of(REFRESH, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(40, 20 * 60 * 3, 20),
                                ...
                                .onCast(PartBuilder
                                                .justAction(SpellAction.REFRESH_COOLDOWNS_BY_X_TICKS.create(20 * 60D))
                                                .addTarget(TargetSelector.CASTER.create()))
                ...
                SpellBuilder.of(REJUVENATION, PlayStyle.INT, SpellConfiguration.Builder.instant(15, 20 * 3),
                                ...
                                .manualDesc("Gives buff that heals nearby allies for "
                                                + SpellCalcs.REJUVENATION.getLocDmgTooltip() + " every second.")
                                .onCast(PartBuilder.playSound(SoundEvents.ILLUSIONER_CAST_SPELL, 1D, 1D))
                                .onCast(PartBuilder.giveExileEffectToAlliesInRadius(8D,
                                                ModEffects.REJUVENATE.resourcePath, 20 * 15D))
                                .levelReq(1)
                                .build();
                ...
                SpellBuilder.of(CIRCLE_OF_HEALING, PlayStyle.INT, SpellConfiguration.Builder.instant(30, 10)
                                ...
                                .manualDesc("Rejuvenate allies around you for "
                                                + SpellCalcs.CIRCLE_OF_HEALING.getLocDmgTooltip() + " health.")
                                .weaponReq(CastingWeapon.ANY_WEAPON)
                ...
                SpellBuilder.of(ENTANGLE_SEED, PlayStyle.INT, SpellConfiguration.Builder.instant(15, 60 * 20)
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.create(
                                                Items.BEETROOT_SEEDS, 1D, SlashEntities.SIMPLE_PROJECTILE.get(), 40D)))

                                .onExpire(PartBuilder
                                                .justAction(SpellAction.EXILE_EFFECT.giveSeconds(ModEffects.PETRIFY, 5))
                                                .enemiesInRadius(3D))
                ...
                SpellBuilder.of(GARDEN_OF_THORNS, PlayStyle.INT, SpellConfiguration.Builder.multiCast(15, 20, 20, 5)
                                ...
                                .manualDesc("Deals " + SpellCalcs.THORN_CONSUME.getLocDmgTooltip(Elements.Physical) +
                                                " in the area and applies Thorns. Gives you Inner Calm which restores "
                                                + SpellCalcs.INNER_CALM.getLocDmgTooltip() + " Mana/s.")
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_AT_SIGHT
                                                .create(SlashEntities.SIMPLE_PROJECTILE.get(), 1D, 4D)))
                                .onExpire(PartBuilder.justAction(SpellAction.SUMMON_BLOCK.create(Blocks.CACTUS, 200D)
                                                ...
                                                .put(MapField.IS_BLOCK_FALLING, true)))
                                .onExpire("block",
                                                PartBuilder.damageInAoe(SpellCalcs.THORN_CONSUME, Elements.Physical, 3D)
                                                                .noKnock())
                                .onExpire("block",
                                                PartBuilder.addExileEffectToEnemiesInAoe(ModEffects.THORN.resourcePath,
                                                                3D, 20 * 10D))
