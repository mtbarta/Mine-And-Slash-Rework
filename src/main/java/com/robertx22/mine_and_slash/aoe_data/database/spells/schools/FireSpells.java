        ...
        public void registerAll() {
                ...
                SpellBuilder.of(MAGMA_FLOWER, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(15, 20 * 30, 20)
                                ...
                                .onExpire(PartBuilder.justAction(
                                                SpellAction.SUMMON_BLOCK.create(SlashBlocks.MAGMA_FLOWER.get(), 20D * 7)
                                ...
                                .onTick("block", PartBuilder.damageInAoe(SpellCalcs.MAGMA_FLOWER, Elements.Fire, 3D)
                                                .tick(20D).noKnock())
                ...
                SpellBuilder.of(FLAME_STRIKE_ID, PlayStyle.STR, SpellConfiguration.Builder.instant(8, 15)
                                ...
                                .onCast(PartBuilder.damageInFront(SpellCalcs.FLAME_STRIKE, Elements.Fire, 2D, 3D)
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.FLAME,
                                                                45D, 1D, 0.1D)))
                                .levelReq(10)
                                .build();

                SpellBuilder.of(VAMP_BLOOD, PlayStyle.STR, SpellConfiguration.Builder.nonInstant(10, 60 * 20 * 3, 30),
                                "Vampiric Blood",
                                ...
                                .onCast(PartBuilder.giveExileEffectToAlliesInRadius(5D,
                                                ModEffects.VAMPIRIC_BLOOD.resourcePath, 20 * 60D))
                                .levelReq(30)
                                .build();

                SpellBuilder.of(DRACONIC_BLOOD, PlayStyle.STR,
                                SpellConfiguration.Builder.nonInstant(10, 60 * 20 * 3, 30), "Draconic Blood",
                                Arrays.asList(SpellTags.FIRE, SpellTags.BUFF))
                                .manualDesc("Gives effect to nearby allies.")
                                .onCast(PartBuilder.playSound(SoundEvents.ILLUSIONER_CAST_SPELL, 1D, 1D))
                                .onCast(PartBuilder.giveExileEffectToAlliesInRadius(5D,
                                                ModEffects.DRACONIC_BLOOD.resourcePath, 20 * 60D))
                                .levelReq(30)
                                .build();
                ...
                SpellBuilder.of(METEOR, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(18, 0, 20)
                                ...
                                .onExpire(PartBuilder
                                                .justAction(SpellAction.SUMMON_BLOCK.create(Blocks.MAGMA_BLOCK, 200D)
                                                                .put(MapField.ENTITY_NAME, "block")
                ...
                SpellBuilder.of(FIRE_NOVA_ID, PlayStyle.STR, SpellConfiguration.Builder.instant(20, 20 * 25),
                                "Fire Nova",
                                Arrays.asList(SpellTags.area, SpellTags.damage, SpellTags.FIRE))
                                .manualDesc(
                                                "Engulf the area in flames, dealing "
                                                                + SpellCalcs.FIRE_NOVA.getLocDmgTooltip()
