...
public class RangerSpells implements ExileRegistryInit {
        ...
        public void registerAll() {
                ...
                SpellBuilder.of(ARROW_TOTEM, PlayStyle.DEX, SpellConfiguration.Builder.instant(25, 10)
                                .setChargesAndRegen("arrow_totem", 3, 20 * 30), "Arrow Totem",
                                Arrays.asList(SpellTags.projectile, SpellTags.damage, SpellTags.totem,
                                                SpellTags.PHYSICAL))

                                .manualDesc("Summons a totem that rapidly shoots arrows, dealing "
                                                + SpellCalcs.ARROW_TOTEM.getLocDmgTooltip(Elements.Physical))

                                .onCast(PartBuilder.playSound(SoundEvents.ILLUSIONER_CAST_SPELL, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_AT_SIGHT
                                                .create(SlashEntities.SIMPLE_PROJECTILE.get(), 1D, 0D)))
                                .onExpire(PartBuilder.justAction(SpellAction.SUMMON_BLOCK
                                                .create(SlashBlocks.PROJECTILE_TOTEM.get(), 20D * 7.5D)
                                                .put(MapField.ENTITY_NAME, "block")
                                                .put(MapField.BLOCK_FALL_SPEED, 0D)
                                                .put(MapField.FIND_NEAREST_SURFACE, false)
                                                .put(MapField.IS_BLOCK_FALLING, false)))

                                .onTick("block", PartBuilder.groundEdgeParticles(ParticleTypes.CRIT, 100D, 3D, 0.5D)
                                                .tick(2D))
                                ...
                                .onTick("block", PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.create(Items.AIR,
                                                ...
                                                .put(MapField.SHOOT_DIRECTION,
                                                                SummonProjectileAction.ShootWay.FIND_ENEMY.name()))
                                                .tick(5D))
                                .onTick("block", PartBuilder.playSound(SoundEvents.ARROW_SHOOT, 1D, 1D).tick(5D))

                                .onExpire("arrow",
                                                PartBuilder.damageInAoe(SpellCalcs.ARROW_TOTEM, Elements.Physical,
                                                                1.5D))
                                .levelReq(20)
                ...
                SpellBuilder.of(BOOMERANG, PlayStyle.DEX, SpellConfiguration.Builder.instant(10, 20 * 5)
                                ...
                                Arrays.asList(SpellTags.projectile, SpellTags.damage, SpellTags.chaining,
                                                SpellTags.PHYSICAL))
                                .manualDesc("Strike enemies with a projectile that deals "
                                                + SpellCalcs.BOOMERANG.getLocDmgTooltip(Elements.Physical))
                                .animations(SpellAnimations.THROW, AnimationHolder.none())
                                .onCast(PartBuilder.playSound(SoundEvents.SNOWBALL_THROW, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE
                                                .create(SlashItems.BOOMERANG.get(), 1D, 1D,
                                                                SlashEntities.SIMPLE_PROJECTILE.get(), 50D, false)
                ...
                SpellBuilder.of(HUNTER_POTION, PlayStyle.DEX, SpellConfiguration.Builder.instant(0, 60 * 20 * 3),
                                "Hunter's Potion",
                                Arrays.asList(SpellTags.heal))
                                .manualDesc("Drink a potion, healing you for "
                                                + SpellCalcs.HUNTER_POTION_HEAL.getLocDmgTooltip() + " health.")
                ...
                trap(FROST_TRAP, "Frost Trap", ParticleTypes.ITEM_SNOWBALL, SpellCalcs.RANGER_TRAP, Elements.Cold)
                                .levelReq(10).build();
                trap(POISON_TRAP, "Acid Trap", ParticleTypes.ITEM_SLIME, SpellCalcs.RANGER_TRAP, Elements.Shadow)
                                .levelReq(30).build();
                trap(FIRE_TRAP, "Fire Trap", ParticleTypes.FLAME, SpellCalcs.RANGER_TRAP, Elements.Fire).levelReq(1)
                                .build();
                ...
                SpellBuilder.of(SMOKE_BOMB, PlayStyle.DEX, SpellConfiguration.Builder.instant(7, 20 * 60), "Smoke Bomb",
                                ...
                                .onCast(PartBuilder
                                                .justAction(SpellAction.AGGRO.create(SpellCalcs.SMOKE_BOMB,
                                                                AggroAction.Type.DE_AGGRO))
                                                .addActions(SpellAction.EXILE_EFFECT.create(
                                                                ModEffects.BLIND.resourcePath,
                                                                ExileEffectAction.GiveOrTake.GIVE_STACKS, 20D * 5))
                                                .addTarget(TargetSelector.AOE.create(10D,
                ...
                SpellBuilder.of(DASH_ID, PlayStyle.DEX, SpellConfiguration.Builder.instant(10, 15)
                                ...
                                .setChargesAndRegen("dash", 3, 20 * 30), "Dash",
                                ...
                                .onCast(PartBuilder.playSound(SoundEvents.CREEPER_PRIMED, 1D, 1.6D)
                                                .addActions(SpellAction.POTION
                                                                .createGive(MobEffects.SLOW_FALLING.value(), 20D))
                ...
                SpellBuilder.of(CHARGED_BOLT, PlayStyle.DEX, SpellConfiguration.Builder.arrowSpell(8, 20 * 15),
                                "Charged Bolt",
                                ...
                                .manualDesc(
                                                "Shoot a slowing charged arrow that goes through enemies and deals "
                                                                + SpellCalcs.CHARGED_BOLT.getLocDmgTooltip() + " "
                                                                + Elements.Nature.getIconNameDmg()
                                                                + " in a radius along its path.")
                                ...
                                .onHit(PartBuilder.damageInAoe(SpellCalcs.CHARGED_BOLT, Elements.Nature, 2D)
                                                .addPerEntityHit(PartBuilder.justAction(SpellAction.POTION
                                                                .createGive(MobEffects.MOVEMENT_SLOWDOWN.value(),
                                                                                40D))))
                ...
                SpellBuilder.of(QUICKDRAW, PlayStyle.DEX, SpellConfiguration.Builder.instant(5, 20 * 5)
                                ...
                                .onCast(PartBuilder.giveSelfEffect(MobEffects.MOVEMENT_SPEED.value(), 20D * 3))
                                .onCast(PartBuilder.justAction(SpellAction.GIVE_ARROWS.create()))
                                .levelReq(10)
                                .build();

                // todo does this do anything?
                SpellBuilder.of(ARROW_STORM, PlayStyle.DEX, SpellConfiguration.Builder.arrowSpell(20, 20 * 25),
                                "Arrow Storm",
                ...
                SpellBuilder.of(GALE_WIND, PlayStyle.DEX, SpellConfiguration.Builder.multiCast(20, 20 * 10, 10, 3),
                                "Gale Wind",
                                Arrays.asList(SpellTags.projectile, SpellTags.damage, SpellTags.PHYSICAL))
                                .manualDesc("Summons multiple clouds, knocking back and dealing "
                                                + SpellCalcs.GALE_WIND.getLocDmgTooltip(Elements.Physical))
                                .onCast(PartBuilder.playSound(SoundEvents.EGG_THROW, 1D, 0.5D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.create(Items.AIR, 5D, 0.5D,
                                                SlashEntities.SIMPLE_PROJECTILE.get(), 40D, false)))
                ...
                SpellBuilder.of(BARRAGE, PlayStyle.DEX, SpellConfiguration.Builder.multiCast(20, 20, 20, 10)
                                ...
                                .manualDesc("Shoot out arrows in rapid succession, dealing "
                                                + SpellCalcs.ARROW_STORM.getLocDmgTooltip(Elements.Physical))
                                .onCast(PartBuilder.playSound(SoundEvents.ARROW_SHOOT, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.createArrow(1D)))
                                .onHit(PartBuilder.particleOnTick(3D, ParticleTypes.CLOUD, 3D, 0.1D))
                ...
                SpellBuilder.of(EXPLOSIVE_ARROW_ID, PlayStyle.DEX, SpellConfiguration.Builder.arrowSpell(10, 20 * 10),
                                "Explosive Arrow",
                                Arrays.asList(SpellTags.projectile, SpellTags.damage, SpellTags.FIRE))
                                .weaponReq(CastingWeapon.RANGED)
                                .manualDesc("Shoot an arrow that upon impact, deals "
                                                + SpellCalcs.EXPLOSIVE_ARROW.getLocDmgTooltip(Elements.Fire)
                                                + " in an area")
                                .onCast(PartBuilder.playSound(SoundEvents.ARROW_SHOOT, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.createArrow(1D)))
                                ...
                                .onExpire(PartBuilder.playSound(SoundEvents.GENERIC_EXPLODE.value(), 1D, 1D))
                ...
                SpellBuilder.of(RECOIL_SHOT, PlayStyle.DEX, SpellConfiguration.Builder.arrowSpell(10, 20 * 10),
                                "Recoil Shot",
                                Arrays.asList(SpellTags.projectile, SpellTags.damage, SpellTags.PHYSICAL))
                                .weaponReq(CastingWeapon.RANGED)
                                .manualDesc("Flip backwards while shooting an arrow that deals "
                                                + SpellCalcs.EXPLOSIVE_ARROW.getLocDmgTooltip(Elements.Physical)
                                                + " and applies Wounds in an area.")
                                .onCast(PartBuilder.playSound(SoundEvents.ARROW_SHOOT, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.createArrow(1D)))
                                .onHit(PartBuilder.damage(SpellCalcs.DIRECT_ARROW_HIT, Elements.Physical))
                                .onCast(PartBuilder.pushCaster(DashUtils.Way.BACKWARDS,
                                                DashUtils.Strength.MEDIUM_DISTANCE))
                                .onHit(PartBuilder.addExileEffectToEnemiesInAoe(ModEffects.WOUNDS.resourcePath, 1D,
                                                20 * 20D))
                                .onHit(PartBuilder.playSound(SoundEvents.ARROW_HIT, 1D, 1D))
                                .onTick(PartBuilder.particleOnTick(5D, ParticleTypes.CRIT, 5D, 0.1D))
                                .levelReq(10)
                ...
                SpellBuilder.of(METEOR_ARROW, PlayStyle.DEX, SpellConfiguration.Builder.arrowSpell(15, 10)
                                ...
                                .onExpire("arrow", PartBuilder.justAction(SpellAction.SUMMON_AT_SIGHT
                                                .create(SlashEntities.SIMPLE_PROJECTILE.get(), 0D, 7D)
                                                .put(MapField.ENTITY_NAME, "height_en")
                                                .put(MapField.DISTANCE, 0D)
                                                .put(MapField.POS_SOURCE, PositionSource.SOURCE_ENTITY.name())))

                                .onExpire("height_en",
                                                PartBuilder.justAction(SpellAction.SUMMON_BLOCK
                                                                .create(Blocks.MAGMA_BLOCK, 200D)
                                ...
                                .onExpire("meteor", PartBuilder.playSound(SoundEvents.GENERIC_EXPLODE.value(), 1D, 1D))
        ...
        static SpellBuilder trap(String id, String name, SimpleParticleType particle, ValueCalculation dmg,
                        Elements element) {
                ...
                return SpellBuilder.of(id, PlayStyle.DEX, SpellConfiguration.Builder.instant(7, 5)
                                ...
                                .manualDesc(
                                                "Throw out a trap that stays on the ground and activates when an enemy approaches to deal "
                                                                + dmg.getLocDmgTooltip() + " "
                                                                + element.getIconNameDmg() + " in area around itself.")
                                .weaponReq(CastingWeapon.ANY_WEAPON)
                                .onCast(PartBuilder.playSound(SoundEvents.SNOWBALL_THROW, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.create(Items.IRON_INGOT,
                                                1D, 0.5D, SlashEntities.SIMPLE_PROJECTILE.get(), 100D, true)))
                                .onExpire(PartBuilder.justAction(
                                                SpellAction.SUMMON_BLOCK.create(SlashBlocks.TRAP.get(), 30 * 20D)
                                ...
                                .addSpecificAction("explode",
                                                PartBuilder.playSound(SoundEvents.GENERIC_EXPLODE.value(), 1D, 1D));
