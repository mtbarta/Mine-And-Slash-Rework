        ...
        public void registerAll() {
                ...
                SpellBuilder.of(CHAIN_LIGHTNING, PlayStyle.INT, SpellConfiguration.Builder.instant(25, 20)
                                ...
                                Arrays.asList(SpellTags.projectile, SpellTags.damage, SpellTags.chaining,
                                                SpellTags.LIGHTNING))
                                .manualDesc(
                                                "Strike enemies with chaining lightning that deals "
                                                                + SpellCalcs.LIGHTNING_SPEAR.getLocDmgTooltip()
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE
                                                .create(SlashItems.LIGHTNING.get(), 1D, 1D,
                                                                SlashEntities.SIMPLE_PROJECTILE.get(), 12D, true)
                ...
                SpellBuilder.of(LIGHTNING_SPEAR, PlayStyle.INT, SpellConfiguration.Builder.instant(5, 20 * 5)
                                ...
                                .manualDesc(
                                                "Throw out an electric spear, dealing "
                                                                + SpellCalcs.LIGHTNING_SPEAR.getLocDmgTooltip()
                                                                + " " + Elements.Nature.getIconNameDmg())
                                .weaponReq(CastingWeapon.MAGE_WEAPON)
                                .onCast(PartBuilder.playSound(SoundEvents.TRIDENT_THROW.value(), 1D, 1D))
                                .onCast(PartBuilder.justAction(
                                                SpellAction.SUMMON_PROJECTILE.create(SlashItems.SLIMEBALL.get(), 1D, 3D,
                                                                SlashEntities.SIMPLE_TRIDENT.get(), 12D, true)))
                ...
                SpellBuilder.of(LIGHTNING_NOVA, PlayStyle.INT, SpellConfiguration.Builder.instant(30, 25 * 10),
                                "Lightning Nova",
                                ...
                                .onCast(PartBuilder.playSound(SoundEvents.TRIDENT_THUNDER.value(), 1D, 1D))
                ...
                SpellBuilder.of(LIGHTNING_TOTEM, PlayStyle.INT, SpellConfiguration.Builder.instant(20, 20 * 60)
                                ...
                                .manualDesc("Summon a lightning totem that deals "
                                                + SpellCalcs.LIGHTNING_TOTEM.getLocDmgTooltip(Elements.Nature)
                                ...
                                .onExpire(PartBuilder.justAction(
                                                SpellAction.SUMMON_BLOCK.create(SlashBlocks.GUARD_TOTEM.get(), 20D * 8)
                                                                .put(MapField.ENTITY_NAME, "block")
                                                                .put(MapField.BLOCK_FALL_SPEED, 0D)
                                                                .put(MapField.FIND_NEAREST_SURFACE, true)
                                                                .put(MapField.IS_BLOCK_FALLING, false)))

                                .onTick("block", PartBuilder.groundEdgeParticles(ParticleTypes.ELECTRIC_SPARK, 20D,
                                                1.5D, 0.2D))
                                .onTick("block", PartBuilder.groundEdgeParticles(ParticleTypes.POOF, 5D, 1.5D, 0.2D))
                                .onTick("block", PartBuilder.playSound(SoundEvents.FIRE_EXTINGUISH, 0.75D, 1D)
                                                .tick(20D))

                                .onTick("block", PartBuilder
                                                .damageInAoe(SpellCalcs.LIGHTNING_TOTEM, Elements.Nature, 6D).noKnock()
                                                .tick(20D)
                                                .noKnock()
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(
                                                                ParticleTypes.ELECTRIC_SPARK, 75D, 1.5D, 0.1D))
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(
                                                                ParticleTypes.ELECTRIC_SPARK, 50D, 1D, 0.1D))
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(
                                                                ParticleTypes.ELECTRIC_SPARK, 100D, 2D, 0.1D)))
