...
public class WaterSpells implements ExileRegistryInit {
        ...
        public void registerAll() {
                ...
                SpellBuilder.of(FROST_LICH_ARMOR, PlayStyle.INT, SpellConfiguration.Builder.instant(100, 20 * 60),
                                "Frost Lich Armor",
                ...
                SpellBuilder.of(BONE_SHATTER_PROC, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(0, 20 * 3, 0),
                                ...
                                .manualDesc("Shatters the ice dealing "
                                                + SpellCalcs.SHATTER_PROC.getLocDmgTooltip(Elements.Cold)
                                                + " and same amount of Physical Damage.")
                                .onCast(PartBuilder.playSound(SoundEvents.GLASS_BREAK, 1D, 1D))
                                .derivesLevelFromSpell(FROST_LICH_ARMOR)

                                .onCast(ParticleBuilder.of(ParticleTypes.SNOWFLAKE, 3.5f)
                                                .shape(ParticleShape.CIRCLE_2D_EDGE).height(1).amount(200).build())
                                .onCast(ParticleBuilder.of(ParticleTypes.ITEM_SNOWBALL, 3.5f)
                                                .shape(ParticleShape.CIRCLE_2D_EDGE).height(1).amount(100).build())
                                .onCast(ParticleBuilder.of(ParticleTypes.CRIT, 3.5f).shape(ParticleShape.CIRCLE_2D_EDGE)
                                                .height(1).amount(55).build())

                                .onCast(DamageBuilder.radius(Elements.Cold, 3, SpellCalcs.SHATTER_PROC).build()
                                                .noKnock())
                                .onCast(DamageBuilder.radius(Elements.Physical, 3, SpellCalcs.SHATTER_PROC).build()
                                                .noKnock())
                ...
                SpellBuilder.of(BLIZZARD, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(35, 20 * 25, 30),
                                ...
                                .manualDesc("Create a Cloud that sends cold waves, damaging enemies for "
                                                + SpellCalcs.BLIZZARD.getLocDmgTooltip(Elements.Cold))
                                ...
                                .onTick("cloud", ParticleBuilder.of(ParticleTypes.SNOWFLAKE, 3f)
                                                .shape(ParticleShape.CIRCLE_2D).amount(80).randomY(0.5F).height(6)
                                                .build())
                                .onTick("cloud", ParticleBuilder.of(ParticleTypes.ITEM_SNOWBALL, 3f)
                                                .shape(ParticleShape.CIRCLE_2D).amount(40).randomY(0.5F).height(6)
                                                .build())

                                .onTick("cloud", DamageBuilder.radius(Elements.Cold, 3, SpellCalcs.BLIZZARD).build()
                                                .noKnock().tick(20D))
                                .onTick("cloud", PartBuilder.addExileEffectToEnemiesInAoe(
                                                ModEffects.BLIZZARD_REDUCE_HEAL_STRENGTH.resourcePath, 3D, 20D))
                ...
                SpellBuilder.of(FROZEN_ORB, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(30, 20 * 30, 25)
                                ...
                                .manualDesc(
                                                "Throw out an orb of ice which slowly moves towards enemies and deals "
                                                                + SpellCalcs.ICEBALL.getLocDmgTooltip()
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE
                                                .create(Items.SNOWBALL, 1D, 0.5D, SlashEntities.SIMPLE_PROJECTILE.get(),
                                                                20 * 10D, false)
                                ...
                                .onTick(ParticleBuilder.of(ParticleTypes.ITEM_SNOWBALL, 0.15F).amount(7).tickReq(3)
                                                .build())
                                .onTick(ParticleBuilder.of(ParticleTypes.SNOWFLAKE, 3F).amount(15).tickReq(3).build()
                                                .tick(20D))
                                .onTick(ParticleBuilder.of(ParticleTypes.ITEM_SNOWBALL, 3F).amount(5).tickReq(3).build()
                                                .tick(20D))
                ...
                SpellBuilder.of(FROST_FLOWER, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(20, 20 * 60, 30)
                                ...
                                .manualDesc("Summon a frost totem that deals "
                                                + SpellCalcs.FROST_FLOWER.getLocDmgTooltip(Elements.Cold)
                                                + " in an area every second.")
                                ...
                                .onExpire(PartBuilder.justAction(
                                                SpellAction.SUMMON_BLOCK.create(SlashBlocks.FROST_FLOWER.get(), 20D * 8)
                                ...
                                .onTick("block", PartBuilder.groundEdgeParticles(ParticleTypes.SNOWFLAKE, 5D, 1.5D,
                                                0.2D))
                                .onTick("block", PartBuilder.playSound(SoundEvents.PLAYER_HURT_FREEZE, 1D, 1D)
                                                .tick(20D))

                                .onTick("block", PartBuilder.damageInAoe(SpellCalcs.FROST_FLOWER, Elements.Cold, 6D)
                                                .tick(20D)
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.RAIN,
                                                                75D, 1D, 0.1D))
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.SPLASH,
                                                                50D, 1D, 0.1D))
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(
                                                                ParticleTypes.SNOWFLAKE, 100D, 1D, 0.1D)))
                ...
                SpellBuilder.of(ICE_COMET, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(18, 0, 20)
                                ...
                                .onCast(PartBuilder.playSound(SoundEvents.ILLUSIONER_CAST_SPELL, 1D, 1D))
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_AT_SIGHT
                                                .create(SlashEntities.SIMPLE_PROJECTILE.get(), 1D, 7D)))
                                .onExpire(PartBuilder
                                                .justAction(SpellAction.SUMMON_BLOCK.create(Blocks.PACKED_ICE, 200D)
                                                                .put(MapField.ENTITY_NAME, "block")
                                ...
                                .onExpire("block", PartBuilder.playSound(SoundEvents.GENERIC_EXPLODE.value(), 1D, 1D))
                                .levelReq(20)
                                .build();
                ...
                SpellBuilder.of(CHILLING_FIELD, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(30, 20 * 30, 30)
                                ...
                                .manualDesc("Spawn a cloud of bone-chilling frost, damaging enemies for "
                                                ...
                                                + " every second and applying slow and Bone Chill.")
                                ...
                                .onTick("block", PartBuilder.groundEdgeParticles(ParticleTypes.SNOWFLAKE, 30D, 2.5D,
                                                0.2D))
                                ...
                                .onTick("block", PartBuilder.damageInAoe(SpellCalcs.CHILLING_FIELD, Elements.Cold, 4D)
                                                .noKnock()
                                                .tick(20D))
                                .onTick("block", PartBuilder
                                                .addExileEffectToEnemiesInAoe(ModEffects.BONE_CHILL.resourcePath, 4D,
                                                                20 * 8D)
                                                .tick(20D))
                                .onTick("block", PartBuilder.addEffectToEnemiesInAoe(
                                                MobEffects.MOVEMENT_SLOWDOWN.value(), 4D,
                                                20D))
                ...
                SpellBuilder.of(HEART_OF_ICE, PlayStyle.INT, SpellConfiguration.Builder.instant(20, 10)
                                .setChargesAndRegen(HEART_OF_ICE, 3, 20 * 30), "Heart of Ice",
                                Arrays.asList(SpellTags.heal, SpellTags.COLD))
                                .manualDesc(
                                                "Heal allies around you for "
                                                                + SpellCalcs.HEART_OF_ICE.getLocDmgTooltip() +
                                                                " health.")
                                .weaponReq(CastingWeapon.ANY_WEAPON)
                                .onCast(PartBuilder.playSound(SlashSounds.BUFF.get(), 1D, 1D))
                                .onCast(PartBuilder.groundParticles(ParticleTypes.SPLASH, 50D, 5D, 0.2D))
                ...
                SpellBuilder.of(MAGE_CIRCLE, PlayStyle.INT, SpellConfiguration.Builder.instant(10, 20 * 45),
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_AT_SIGHT
                                                .create(SlashEntities.SIMPLE_PROJECTILE.get(), 1D, 0D)))
                                .onExpire(PartBuilder.justAction(
                                                SpellAction.SUMMON_BLOCK.create(SlashBlocks.GLYPH.get(), 20D * 10)
                                                                .put(MapField.ENTITY_NAME, "block")
                                                                .put(MapField.BLOCK_FALL_SPEED, 0D)
                                                                .put(MapField.FIND_NEAREST_SURFACE, false)
                                                                .put(MapField.IS_BLOCK_FALLING, false)))
                ...
                SpellBuilder.of(TIDAL_STRIKE, PlayStyle.STR, SpellConfiguration.Builder.instant(8, 12)
                                ...
                                .onCast(PartBuilder.damageInFront(SpellCalcs.TIDAL_STRIKE, Elements.Cold, 2D, 3D)
                                                ...
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.SPLASH,
                                                                50D, 1D, 0.1D))
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.BUBBLE,
                                                                100D, 1D, 0.1D)))
                                .levelReq(10)
                                .build();

                SpellBuilder.of(FROST_NOVA_AOE, PlayStyle.INT, SpellConfiguration.Builder.instant(30, 25 * 20),
                                "Frost Nova",
                                Arrays.asList(SpellTags.area, SpellTags.damage, SpellTags.COLD))
                                .manualDesc(
                                                "Explode with frost around you, dealing "
                                                                + SpellCalcs.FROST_NOVA.getLocDmgTooltip()
                                                                + " " + Elements.Cold.getIconNameDmg()
                                                                + " to nearby enemies.")
                                ...
                                .onCast(PartBuilder.playSound(SoundEvents.GENERIC_EXPLODE.value(), 0.8D, 1.5D))
                                .onCast(PartBuilder.damageInAoe(SpellCalcs.FROST_NOVA, Elements.Cold, 5D)
                                                .addPerEntityHit(PartBuilder
                                                                .playSoundPerTarget(SoundEvents.GENERIC_HURT, 1D, 1D)))
                                .levelReq(1)
                                .build();
