...
public class GuiOverlays {
    ...
    public static void registerOverlay(RegisterGuiOverlaysEvent event) {
        ...
        event.registerAbove(VanillaGuiOverlay.CHAT_PANEL.id(), SlashRef.MODID + ".spell_hotbar", new IGuiOverlay() {
            @Override
            public void render(net.neoforged.neoforge.client.gui.overlay.ExtendedGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
