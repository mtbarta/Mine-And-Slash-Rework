...
public class ServerContainer {
    ...
    ServerContainer(ModConfigSpec.Builder b) {
        ...
        COMBAT_TO_PROFESSION_RESTED_XP_GENERATION = b.defineInRange("COMBAT_TO_PROFESSION_RESTED_XP_GENERATION", 0.25,
                0, 1);
        PROFESSION_TO_COMBAT_RESTED_XP_GENERATION = b.defineInRange("PROFESSION_TO_COMBAT_RESTED_XP_GENERATION", 0.1, 0,
                1);
        RESTED_XP_DEATH_PENALTY = b.defineInRange("RESTED_XP_DEATH_PENALTY", 0.5F, 0, 1);
        PARTY_EXP_BONUS = b.comment("Additional exp before splitting between players.").defineInRange("PARTY_EXP_BONUS",
                0.2F, 0, 1);
        ...
        BONUS_EXP_PERCENT_PER_HIGHER_LVL_CHARACTERS = b.defineInRange("BONUS_EXP_PERCENT_PER_HIGHER_LVL_CHARACTERS", 10,
                0, 1000);
                        ...
                        try {
                            ...
                            if (item != Items.AIR && item != null) {
                                if (!ExileDB.GearSlots().isRegistered(array[2])) {
                                    cachedCompatMap.put(item, null); // if invalid, make the item have no gear type,
                                                                     // this was requested as a way to blacklist
                                } else {
