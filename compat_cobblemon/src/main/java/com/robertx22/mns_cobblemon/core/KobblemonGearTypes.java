...
public class KobblemonGearTypes implements ExileRegistryInit {
        ...
        public void registerAll() {
                ...
                BaseGearType heldType = new BaseGearType(KobblemonGearSlots.POKEMON_HELD, POKEMON_HELD_ITEM.GUID(),
                                "Held Item");
                heldType.tags.add(SlotTag.of("pokemon_held_item"));
                // Add base damage so held items function as weapons
                heldType.base_stats.add(
                                new StatMod(5, 10, OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Physical), ModType.FLAT));
                heldType.base_stats.add(
                                new StatMod(5, 10, OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Shadow), ModType.FLAT));
                ...
                // ===== BATTLE ITEMS =====
                BaseGearType battleType = new BaseGearType(KobblemonGearSlots.POKEMON_BATTLE,
                                POKEMON_BATTLE_ITEM.GUID(),
                                "Battle Item");
                battleType.tags.add(SlotTag.of("pokemon_held_item"));
                // Add base damage
                battleType.base_stats.add(
                                new StatMod(5, 10, OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Physical), ModType.FLAT));
                battleType.base_stats.add(
                                new StatMod(5, 10, OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Shadow), ModType.FLAT));
                ...
                battleType.possible_items
                                .add(new BaseGearType.ItemChance(80, "mns_cobblemon:never_melt_ice", "common"));
                ...
                // ===== TRAINING ITEMS =====
                BaseGearType trainingType = new BaseGearType(KobblemonGearSlots.POKEMON_TRAINING,
                                POKEMON_TRAINING_ITEM.GUID(),
                                "Training Item");
                trainingType.tags.add(SlotTag.of("pokemon_held_item"));

                // Power items (EV training)
                trainingType.possible_items
                                .add(new BaseGearType.ItemChance(100, "mns_cobblemon:power_weight", "common"));
                trainingType.possible_items
                                .add(new BaseGearType.ItemChance(100, "mns_cobblemon:power_bracer", "common"));
                ...
                trainingType.possible_items
                                .add(new BaseGearType.ItemChance(100, "mns_cobblemon:power_anklet", "common"));
                ...
                trainingType.possible_items
                                .add(new BaseGearType.ItemChance(80, "mns_cobblemon:soothe_bell", "uncommon"));
                ...
                BaseGearType megaType = new BaseGearType(KobblemonGearSlots.POKEMON_MEGA, POKEMON_MEGA_STONE.GUID(),
                                "Mega Stone");
                megaType.tags.add(SlotTag.of("pokemon_held_item"));
