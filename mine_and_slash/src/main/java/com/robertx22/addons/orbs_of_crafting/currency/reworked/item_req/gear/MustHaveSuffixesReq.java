...
public class MustHaveSuffixesReq extends GearRequirement {

    public MustHaveSuffixesReq(String id) {
        super(ItemReqSers.HAS_SUFFIXES, id);
    }

    @Override
    public Class<?> getClassForSerialization() {
        return MustHaveSuffixesReq.class;
    }
    ...
    public TranslationBuilder createTranslationBuilder() {
        return TranslationBuilder.of(SlashRef.MODID)
                .desc(ExileTranslation.registry(this, "Must have suffixes")
                );
    }
    ...
    public boolean isGearValid(ItemStack stack) {
        ...
        return gear.affixes != null && gear.affixes.getNumberOfSuffixes() > 0;
    }
}
