...
public class MustHavePrefixesReq extends GearRequirement {

    public MustHavePrefixesReq(String id) {
        super(ItemReqSers.HAS_PREFIXES, id);
    }

    @Override
    public Class<?> getClassForSerialization() {
        return MustHavePrefixesReq.class;
    }
    ...
    public TranslationBuilder createTranslationBuilder() {
        return TranslationBuilder.of(SlashRef.MODID)
                .desc(ExileTranslation.registry(this, "Must have prefixes")
                );
    }
    ...
    public boolean isGearValid(ItemStack stack) {
        ...
        return gear.affixes != null && gear.affixes.getNumberOfPrefixes() > 0;
    }
}
