...
public class SummonSpells implements ExileRegistryInit {
        ...
        public void registerAll() {
                ...
                SpellBuilder.of(SUMMON_FIRE_GOLEM, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(40, 20 * 60, 30)
                                ...
                                "Summon Fire Golem",
                                Arrays.asList(SpellTags.summon, SpellTags.damage, SpellTags.golem,
                                                SpellTags.has_pet_ability, SpellTags.FIRE))
                ...
                SpellBuilder.of(SUMMON_COLD_GOLEM, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(40, 20 * 60, 30)
                                ...
                                "Summon Frost Golem",
                                Arrays.asList(SpellTags.summon, SpellTags.damage, SpellTags.golem,
                                                SpellTags.has_pet_ability, SpellTags.COLD))
                ...
                SpellBuilder.of(SUMMON_LIGHTNING_GOLEM, PlayStyle.INT, SpellConfiguration.Builder
                                .nonInstant(40, 20 * 60, 30)
                                .setSummonBasicAttack(PetSpells.LIGHTNING_GOLEM).setSummonType(SummonType.GOLEM),
                                "Summon Lightning Golem",
                                Arrays.asList(SpellTags.summon, SpellTags.damage, SpellTags.golem,
                                                SpellTags.has_pet_ability, SpellTags.LIGHTNING))
                ...
                SpellBuilder.of(SUMMON_SPIRIT_WOLF, PlayStyle.INT,
                                SpellConfiguration.Builder.nonInstant(30, 30 * 20, 30)
                ...
                SpellBuilder.of(SUMMON_ZOMBIE, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(30, 20 * 60, 40)
                                ...
                                .summons(SlashEntities.ZOMBIE.get(), SummonPetAction.INFINITE_DURATION, 1,
                                                SummonType.UNDEAD)
                                .addStat(OffenseStats.SUMMON_DAMAGE.get().mod(10, 50))
                ...
                SpellBuilder.of(SUMMON_SKELETAL_ARMY, PlayStyle.INT,
                                SpellConfiguration.Builder.nonInstant(35, 20 * 3, 40)
                ...
                SpellBuilder.of(RETURN_SUMMONS, PlayStyle.STR, SpellConfiguration.Builder.instant(15, 20 * 30),
                                "Return Summons",
                                Arrays.asList(SpellTags.area, SpellTags.heal, SpellTags.summon))
                                .singleAnimation(SpellAnimations.PULL)

                                .manualDesc("Regroup your summons and heal them for "
                                                + SpellCalcs.HEALING_AURA.getLocDmgTooltip() + " health.")
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.TP_TARGET_TO_SELF.create())
                                                .addActions(SpellAction.POTION.createGive(
                                                                MobEffects.MOVEMENT_SLOWDOWN.value(), 20D * 5))
                                                .addActions(SpellAction.DEAL_DAMAGE.create(SpellCalcs.PULL,
                                                                Elements.Physical))
                                                .addActions(SpellAction.EXILE_EFFECT.create(
                                                                ModEffects.STUN.resourcePath,
                                                                ExileEffectAction.GiveOrTake.GIVE_STACKS, 20D * 2))
                                                .addTarget(TargetSelector.AOE.create(30D,
                                                                EntityFinder.SelectionType.RADIUS, AllyOrEnemy.pets))
                                                .addPerEntityHit(PartBuilder.justAction(SpellAction.RESTORE_HEALTH
                                                                .create(SpellCalcs.HEALING_AURA)))
                                                .addPerEntityHit(PartBuilder
                                                                .justAction(SpellAction.TP_TARGET_TO_SELF.create())))
                ...
                SpellBuilder.of(CHILLING_TOUCH, PlayStyle.STR, SpellConfiguration.Builder.instant(8, 20 * 5)
                                ...
                                .manualDesc("Strike enemies in front for " +
                                                ...
                                                + ", and command your summons to attack them.")
                                ...
                                .onCast(PartBuilder.damageInFront(SpellCalcs.CHILLING_TOUCH, Elements.Cold, 2D, 3D)
                                                ...
                                                .addPerEntityHit(PartBuilder.justAction(
                                                                SpellAction.COMMAND_SUMMONS_ATTACK.create())))
                                .levelReq(1)
                                .build();

                SpellBuilder.of(EXPLODE_MINIONS, PlayStyle.INT, SpellConfiguration.Builder.instant(30, 20 * 5)
                                .setSwingArm(), "Explode Minions",
                                Arrays.asList(SpellTags.area, SpellTags.damage, SpellTags.minion_explode,
                                                SpellTags.summon, SpellTags.FIRE))
                                .manualDesc("Explodes all your nearby minions for "
                                                + SpellCalcs.EXPLODE_MINION.getLocDmgTooltip(Elements.Fire)
                                                + ". Summon HP stat acts as a damage bonus for this spell.")

                                .addSpecificAction("explode",
                                                PartBuilder.damageInAoe(SpellCalcs.EXPLODE_MINION, Elements.Fire, 3D))
                                ...
                                .onCast(PartBuilder.selectSummons(10D)
                                                .addPerEntityHit(PartBuilder.playSound(
                                                                SoundEvents.GENERIC_EXPLODE.value(), 1D,
                                                                1D))
                                                .addPerEntityHit(PartBuilder.aoeParticles(ParticleTypes.EXPLOSION, 10D,
                                                                3D))
                                                .addPerEntityHit(PartBuilder
                                                                .aoeParticles(ParticleTypes.EXPLOSION_EMITTER, 2D, 1D))
                                                .addPerEntityHit(PartBuilder.justAction(
                                                                SpellAction.SPECIFIC_ACTION.create("explode")))
