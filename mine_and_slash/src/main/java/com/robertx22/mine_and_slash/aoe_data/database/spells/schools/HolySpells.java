...
public class HolySpells implements ExileRegistryInit {
        ...
        public void registerAll() {
                ...
                /*
                 * SpellBuilder.of(HOLY_MISSILES, PlayStyle.INT,
                 * SpellConfiguration.Builder.multiCast(30, 10, 25, 8)
                 ...
                 * .animations(SpellAnimations.STAFF_CAST_WAVE_LOOP,
                 * SpellAnimations.STAFF_CAST_FINISH)
                 * .manualDesc(
                 * "Fire off Missiles that slowly move towards enemies and deal " +
                 * SpellCalcs.HOLY_MISSILES.getLocDmgTooltip()
                 * + " " + Elements.Nature.getIconNameDmg() + ".")
                 * 
                 * .weaponReq(CastingWeapon.MAGE_WEAPON)
                 * .onCast(PartBuilder.playSound(SoundEvents.WITCH_THROW, 1D, 2D))
                 * .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE.create(Items.
                 * AIR, 1D, 0.3D, SlashEntities.SIMPLE_PROJECTILE.get(), 20 * 8D, false)
                 ...
                 * 
                 * .onHit(DamageBuilder.target(Elements.Nature,
                 * SpellCalcs.HOLY_MISSILES).build())
                 * 
                 * .build();
                 * 
                 */
                ...
                SpellBuilder.of(WHIRLWIND, PlayStyle.STR, SpellConfiguration.Builder.multiCast(10, 0, 100, 10)
                                ...
                                Arrays.asList(SpellTags.weapon_skill, SpellTags.area, SpellTags.damage,
                                                SpellTags.PHYSICAL))
                                .manualDesc("Spin and continuously strike enemies around you for "
                                                + SpellCalcs.WHIRLWIND.getLocDmgTooltip(Elements.Physical))
                                ...
                                .onCast(PartBuilder.damageInAoe(SpellCalcs.WHIRLWIND, Elements.Physical, 1.5D)
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.EFFECT,
                                                                50D, 0.5D, 0.1D)))
                                .levelReq(30)
                                .build();
                ...
                SpellBuilder.of(CHARGE_ID, PlayStyle.STR, SpellConfiguration.Builder.multiCast(10, 20 * 10, 60, 60),
                                ...
                                .manualDesc(
                                                "Charge in a direction, stopping upon first enemy hit to deal "
                                                                + SpellCalcs.CHARGE.getLocDmgTooltip() + " "
                                                                + Elements.Physical.getIconNameDmg() + " in an area."
                                ...
                                .onCast(PartBuilder
                                                .justAction(SpellAction.SET_ADD_MOTION
                                                                .create(SetAdd.ADD, 0.4D, ParticleMotion.CasterLook)
                                ...
                                .onCast(PartBuilder.damageInAoe(SpellCalcs.CHARGE, Elements.Physical, 1.75D)
                                                ...
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.EFFECT,
                                                                100D, 0.5D, 0.1D))
                                                .addPerEntityHit(PartBuilder.groundEdgeParticles(ParticleTypes.CLOUD,
                                                                100D, 0.5D, 0.1D))
                ...
                SpellBuilder.of(TAUNT, PlayStyle.STR, SpellConfiguration.Builder.instant(0, 20 * 30)
                                ...
                                .manualDesc(
                                                "Shout, making nearby enemies want to attack you. " +
                                                                "Generates " + SpellCalcs.TAUNT.getLocDmgTooltip()
                                                                + " threat.")
                                ...
                                .onCast(PartBuilder
                                                ...
                                                .addTarget(TargetSelector.AOE.create(3D,
                ...
                SpellBuilder.of(PULL, PlayStyle.STR, SpellConfiguration.Builder.instant(5, 60 * 20), "Pull",
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.TP_TARGET_TO_SELF.create())
                                                ...
                                                .addTarget(TargetSelector.AOE.create(8D,
                                                                EntityFinder.SelectionType.RADIUS,
                                                                AllyOrEnemy.enemies)))
                ...
                SpellBuilder.of(GONG_STRIKE_ID, PlayStyle.STR, SpellConfiguration.Builder.instant(8, 20 * 10)
                                ...
                                .onCast(PartBuilder.addExileEffectToEnemiesInFront(ModEffects.STUN.resourcePath, 2D, 2D,
                                                20D * 3))
                ...
                SpellBuilder.of(INSPIRATION, PlayStyle.INT, SpellConfiguration.Builder.instant(0, 300 * 20),
                                "Inspiration",
                ...
                SpellBuilder.of(SHOOTING_STAR, PlayStyle.INT, SpellConfiguration.Builder.instant(10, 20)
                                ...
                                .manualDesc("Shoots a star that heals allies for "
                                                + SpellCalcs.SHOOTING_STAR.getLocDmgTooltip() + " health on hit.")
                                ...
                                .onCast(PartBuilder.justAction(SpellAction.SUMMON_PROJECTILE
                                                .create(Items.NETHER_STAR, 1D, 1D,
                ...
                SpellBuilder.of(HEALING_AURA_ID, PlayStyle.INT,
                                SpellConfiguration.Builder.multiCast(15, 20 * 30, 60, 3), "Healing Aria",
                                Arrays.asList(SpellTags.area, SpellTags.heal, SpellTags.song))
                                .manualDesc(
                                                "Heal allies around you for "
                                                                + SpellCalcs.HEALING_AURA.getLocDmgTooltip() +
                                                                " health")
        ...
        static void song(String id, String name, EffectCtx effect) {
                ...
                SpellBuilder.of(id, PlayStyle.INT, SpellConfiguration.Builder.nonInstant(10, 20 * 10, 10), name,
