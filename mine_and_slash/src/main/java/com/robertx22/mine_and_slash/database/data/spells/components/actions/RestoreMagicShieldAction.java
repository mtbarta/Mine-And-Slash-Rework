...
public class RestoreMagicShieldAction extends SpellAction {
        ...
        try {
            if (!ctx.world.isClientSide) {
                ...
                for (LivingEntity t : targets) {
                    ...
                    RestoreResourceEvent restore = EventBuilder.ofRestore(ctx.caster, t, ResourceType.magic_shield, RestoreType.heal, value)
