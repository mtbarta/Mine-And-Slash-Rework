...
public class RestoreBloodAction extends SpellAction {

    public RestoreBloodAction() {
        ...
        try {
            if (!ctx.world.isClientSide) {
                ...
                for (LivingEntity t : targets) {
                    ...
                    RestoreResourceEvent restore = EventBuilder.ofRestore(ctx.caster, t, ResourceType.blood, RestoreType.heal, value)
