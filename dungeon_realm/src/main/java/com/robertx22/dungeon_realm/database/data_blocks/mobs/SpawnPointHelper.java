...
// idk if this is helping much
public class SpawnPointHelper {

    public static BlockPos getBestSpawnPosition(BlockGetter world, BlockPos target) {
        return getBestSpawnPosition(world, target, target.offset(-5, -3, -5), target.offset(5, 3, 5));
    }
