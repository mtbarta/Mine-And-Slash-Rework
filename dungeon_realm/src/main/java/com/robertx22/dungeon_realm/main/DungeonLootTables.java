...
public class DungeonLootTables {
        ...
        public static final ResourceLocation TIER_1_DUNGEON_CHEST_ID = ResourceLocation.fromNamespaceAndPath(
                        DungeonMain.MODID,
                        "chests/tier_1_dungeon");
        public static final ResourceLocation TIER_2_DUNGEON_CHEST_ID = ResourceLocation.fromNamespaceAndPath(
                        DungeonMain.MODID,
                        "chests/tier_2_dungeon");
        public static final ResourceLocation TIER_3_DUNGEON_CHEST_ID = ResourceLocation.fromNamespaceAndPath(
                        DungeonMain.MODID,
                        "chests/tier_3_dungeon");
        public static final ResourceLocation TIER_4_DUNGEON_CHEST_ID = ResourceLocation.fromNamespaceAndPath(
                        DungeonMain.MODID,
                        "chests/tier_4_dungeon");
        public static final ResourceLocation TIER_5_DUNGEON_CHEST_ID = ResourceLocation.fromNamespaceAndPath(
                        DungeonMain.MODID,
